        ...
        <Grid container sx={{ marginX: 2, justifyContent: "center" }}>
          <Grid item xs={12} sm={8} md={6}>
            ...
            <Box>
              ...
              <LinearProgress value={68} variant="determinate" />
            </Box>
            <Box>
              <form
                style={{
              ...
              >
                ...
                >
                  <Button
                    variant="light"
                    onClick={() => navigate("/signup/non-owner/createAccount")}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => navigate("/signup/non-owner/payment-mode")}
                  >
                    Next
                    <MdArrowForwardIos
...
export default NonOwnerCreateAccount2;
