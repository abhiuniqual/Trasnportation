          ...
          <Grid item xs={12} sm={8} md={6}>
            ...
            <Box>
              <Typography variant="subtitle1" sx={{ paddingBottom: "10px" }}>
                Add your legal representative or authorised person information
              </Typography>
              ...
              >
                ...
                >
                  <Button
                    variant="light"
                    onClick={() =>
                      navigate("/signup/RoadFrieght/companyAccount2")
                    }
                  >
...
export default CompanyAccount3;
